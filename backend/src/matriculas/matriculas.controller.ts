...
// Chama o método create() do service, passando o corpo da requisição como dados
    ...
    findOne(@Param('fk_disciplinas_id_fk_estudantes_fk_usuarios_id') fk_disciplinas_id_fk_estudantes_fk_usuarios_id: string) {
    ...
    update(@Param('fk_disciplinas_id_fk_estudantes_fk_usuarios_id') fk_disciplinas_id_fk_estudantes_fk_usuarios_id: string, @Body() body: any) {
// Chama o método update() do service, passando o ID (como número) e os novos dados
    ...
    remove(
        ...
        return this.matriculasService.remove(+fk_disciplinas_id,
